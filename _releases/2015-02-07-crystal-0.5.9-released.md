...
a port of [prax](https://github.com/ysbaddaden/prax), which is a pure Ruby alternative to [Pow](https://web.archive.org/web/20150225093309/http://pow.cx/).
...
named [crystal shards](https://web.archive.org/web/20151025104136/http://crystalshards.herokuapp.com/), hosted on [Heroku](https://github.com/zamith/heroku-buildpack-crystal),
