...
special thing about it. It has its own type ([API docs](http://crystal-lang.org/api/Tuple.html))
...
but that's the only special thing about it. It has its own type ([API docs](http://crystal-lang.org/api/NamedTuple.html))
and you can reopen and add methods to it.
...
The detailed algorithm is explained [in the language reference](http://crystal-lang.org/docs/syntax_and_semantics/default_values_named_arguments_splats_tuples_and_overloading.html),
...
> bug reports, bug fixes, comments, suggestions or donations.
