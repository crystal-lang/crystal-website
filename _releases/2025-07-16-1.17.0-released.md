...
- [`IO::FileDescriptor#blocking`] and [`#blocking=`][`FileDescriptor#blocking=`] are deprecated. The
  ...
  manipulating the blocking state. It only works on Unix systems, though. ([#15924])

[`FileDescriptor#blocking=`]: https://crystal-lang.org/api/1.17.0/FileDescriptor.html#blocking=-instance-method
