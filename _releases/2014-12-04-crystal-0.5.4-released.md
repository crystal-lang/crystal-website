...
You can install Crystal by following [these instructions](/_pages/install.md).

> **THANKS:**
> We'd like to thank everyone that help us by sending pull requests, suggesting improvements and changes,
> adding documentation, fixing typos and talking about it in social media like [Twitter](https://twitter.com/search?q=crystal-lang.org)
