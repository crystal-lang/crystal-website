...
Read [the full changelog](https://github.com/crystal-lang/crystal/releases/tag/0.11.0).
...
and `init` (creates an initial shard.yml), as well as some bug fixes. Read [the changelog](https://github.com/ysbaddaden/shards/releases/tag/v0.6.0).
