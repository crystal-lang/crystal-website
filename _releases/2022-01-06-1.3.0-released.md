...
Primitive numeric values are now _autocasted_ to fit into larger types. For instance, it is possible to call a function expecting an `Int64` with an `Int32` (note that before 1.3.0 only number _literals_ were autocasted):
