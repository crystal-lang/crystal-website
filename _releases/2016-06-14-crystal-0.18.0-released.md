...
to parse the string for each type in the union, as can be seen [in this example](https://github.com/crystal-lang/crystal/blob/25b79258913d0d3f2859fa6db4f302f47b025e95/src/json/from_json.cr#L191-L228)
...
Named tuples were introduced in the [previous release](2016-05-17-crystal-0.17.0-released.md)
