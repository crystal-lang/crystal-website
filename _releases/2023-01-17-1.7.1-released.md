...
This patch only includes a bugfix for a regression introduced in 1.7.0 affecting the playground. With this patch the playground should be working again. If you find any further issue, please [report it](https://crystal-lang.org/issues).
