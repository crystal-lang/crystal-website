...
- Use per-scheduler stack pools (let's recycle) ([#14100](https://github.com/crystal-lang/crystal/issues/14100)).
...
- Add `CRYSTAL_CONFIG_CC` compiler config variable. This bakes in a reference to a specific compiler which is useful for 3rd party package managers such as home brew so that the compiler picks up the appropriate library paths ([#14318](https://github.com/crystal-lang/crystal/pull/14318)).
