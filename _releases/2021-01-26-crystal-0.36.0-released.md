...
Note that this release will be available in [the new apt and rpm repositories post](/_posts/2020-08-24-announcing-new-apt-and-rpm-repositories.md), as well as GitHub release artifacts. You might need to update your package repositories.
...
The CI infrastructure for AArch64 hosted by [works on arm](https://www.arm.com/markets/cloud-ai/works-on-arm) is making progress. We are still not releasing official packages. Read more at [#9508](https://github.com/crystal-lang/crystal/pull/9508).
...
> **THANKS:**
> We have been able to do all of this thanks to the continued support of [84codes](https://www.84codes.com/), [Nikola Motor Company](https://nikolamotor.com/) and every other [sponsor](/_pages/sponsors.md). It is extremely important for us to sustain the support through donations, so that we can maintain this development pace. [OpenCollective](https://opencollective.com/crystal-lang) is available for that.
>
