...
Right now we are busy preparing a great talk for [Curry On](https://web.archive.org/web/20150402131136/http://curry-on.org/), we are thrilled
to have been selected! You can see [the detailed abstract of the talk](http://2015.ecoop.org/event/curryon-crystal-a-programming-language-for-humans-and-computers).
