...
The bugfixes for PCRE2 are important to help migrating projects into the newly supported library. Mind that support for the old regex library will gradually [fade out](https://crystal-lang.org/2023/03/02/crystal-is-upgrading-its-regex-engine/).
