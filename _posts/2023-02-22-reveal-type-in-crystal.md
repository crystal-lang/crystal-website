...
Recently I came across with [`reveal_type` from Sorbet](https://sorbet.org/docs/flow-sensitive#example) as a way to inspect the type of an expression, thanks [Brian Hicks](https://www.brianthicks.com/). I wondered if that can be ported to Crystal. You can jump to the [conclusions](#conclusions) section if you want to copy-paste the good-enough™️ solution in your project.
...
About 8 years ago Crystal [gain some built-in tooling](/2015/09/05/tools/). One of those tools will give us exactly the information we are looking for.
