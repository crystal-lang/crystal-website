...
It will be up to you to start choosing the correct operators -- with or without ampersand. This usually depends on how the data is used: business logic and data science usually should overflow, while transport protocol implementation, checksums and low level programming might benefit from the raising operators.
