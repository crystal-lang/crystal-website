...
Here we'll [continue explaining](2013-09-23-type-inference-part-1.md) how Crystal assigns
...
(if you are not sure what `&.abs` means, [read this](2013-09-15-to-proc.md))
...
[in the blog post _Null Pointer Exception_](2013-07-13-null-pointer-exception.md), but now we'll explain it
