...
At the end of 2014 a [first draft](https://github.com/manastech/heroku-buildpack-crystal/commit/b364f9115706a2a1c97ff40bd44aef1cf73e6288) of a [Heroku](https://heroku.com) buildpack for crystal was created. This was truly great. Being able to run crystal apps in the Heroku stack was charm idea.
...
Right now the project knows nothing about Heroku. To get started, a Heroku application needs first to be registered. The easiest way to do this is via the [Heroku toolbelt](https://web.archive.org/web/20160504032153/https://toolbelt.heroku.com/):
